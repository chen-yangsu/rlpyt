...
"""
Runs one instance of the environment and optimizes using the Proximal Policy Optimization
algorithm. Can use a GPU for the agent (applies to both sample and
